/*
Thu Apr 23 2015 09:36:04 GMT+0800 (CST)
combined files by KMD:

index.js
*/

KISSY.add('kg/number-zoom/1.1.2/index',["node","base","overlay"],function(S ,require, exports, module) {
//数字放大器，同时会显示中文单位
// by 剑平（明河）
...
var NumberZoom = Base.extend({
    initializer:function(){
        ...
        $target.on('focusin valuechange',function(e){
            ...
            if(str.length > 0 && Number(str.replace(/,/g,'')) > 0 ){
